...
public class MqttService {
    ...
    private final com.tracksecure.mqttrestapp.websocket.SensorWebSocketHandler sensorWebSocketHandler;
        ...
        try {
            ...
            client.subscribe("sensor/dht11", (topic, msg) -> {
                ...
                try {
                    ...
                    try {
                        sensorWebSocketHandler.broadcastSensorData(data);
                    } catch (Exception e) {
                        log.warn("Failed to broadcast DHT update via WebSocket: {}", e.getMessage());
                    }
            ...
            client.subscribe("sensor/gps", (topic, msg) -> {
                ...
                try {
                    ...
                    try {
                        ...
                        log.warn("Failed to broadcast GPS update via WebSocket: {}", e.getMessage());
                    }
